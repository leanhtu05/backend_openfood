...
# Tạo kế hoạch ăn uống thứ hai để so sánh
print("\n\nĐang tạo kế hoạch ăn uống thứ hai để so sánh...")
...
# Kiểm tra tính đa dạng của kế hoạch thứ hai
print_meal_plan_variety(weekly_plan_2) 